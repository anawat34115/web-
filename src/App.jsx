...
function App() {
  ...
  useEffect(() => {
    setTimeout(() => {
      injectJavascript('./public/assets/js/jquery.js')
      injectJavascript('./public/assets/js/waypoints.js')
      injectJavascript('./public/assets/js/bootstrap.bundle.min.js')
      injectJavascript('./public/assets/js/swiper-bundle.js')
      injectJavascript('./public/assets/js/slick.js')
      injectJavascript('./public/assets/js/magnific-popup.js')
      injectJavascript('./public/assets/js/counterup.js')
      injectJavascript('./public/assets/js/wow.js')
      injectJavascript('./public/assets/js/nice-select.js')
      injectJavascript('./public/assets/js/meanmenu.js')
      injectJavascript('./public/assets/js/isotope-pkgd.js')
      injectJavascript('./public/assets/js/imagesloaded-pkgd.js')
      injectJavascript('./public/assets/js/ajax-form.js')
      injectJavascript('./public/assets/js/main.js')
    }, )
  })
